 ...
 */
final class Version20250207111340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, idcommande INT NOT NULL, dateheurecommande DATETIME NOT NULL, iduser_id INT NOT NULL, UNIQUE INDEX UNIQ_6EEAA67D786A81FB (iduser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
